      ...
      <div className="section-outer panel py-6 xl:py-9 bg-secondary dark:bg-gray-800">
        ...
        <div className="container max-w-lg">
          <div className="section-inner panel">
            ...
            >
              <h2 className="h3 lg:h2 mb-4">Other Interests</h2>
              <p className="fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70">
                As well as technology, I have many other interests and hobbies which I adore!
              </p>
              <p className="fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70">
                A passionate musician, I always jump at the chance to sing a song, strum a tune, play a melody or drum a beat!
                I also spend (probably too much) time researching history. Indeed, you will never persuade me to put down a good historical book,
                especially if it's about Ancient Rome and the Punic Wars! I practise endurance sports such as long-distance running and
                hiking in the beautiful Cornish countryside, although I do spend a fair share of time gaming. Overall, however,
                nothing excites me more than a good bit of travel, and I value experiences of cultures around the world
                most highly, especially loving Thailand and my home country of Spain.
              </p>
