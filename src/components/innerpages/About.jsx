          ...
          >
            <div className="vstack items-center gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-850px mx-auto text-center">
              ...
              <p className="fs-6 md:fs-5 text-dark dark:text-white text-opacity-70">
                I am highly passionate about and devoted to computing, and specifically artificial intelligence. Starting in primary school, I have
                pursued these interests through projects, courses, research and more, particularly relishing in opportunities to apply CS to scientific,
                real-world problems. This sparked my love for AI at the age of 14, allowing me to, through the magic of probability, explore the problems
                we face and the discoveries we have yet to make. I am also intrigued by the philosophical and psychological discussions surrounding AI,
                and am always keen to debate the neuroscientific implications of neural networks!
              </p>
            </div>
              ...
              <div className="col-4">
                <figure className="featured-image m-0 rounded ratio ratio-2x3 sm:rounded-2 uc-transition-toggle overflow-hidden">
                  <img
                    ...
                    alt="About image"
                    src="/assets/images/resume/snowboard.png"
                    width="1000"
                    height="1500"
                  />
                </figure>
                ...
                <div className="h-100">
                  <figure className="panel h-100 m-0 rounded sm:rounded-2 overflow-hidden">
                    ...
                    <img
                      ...
                      alt="About image"
                      src="/assets/images/resume/drumming.png"
                      width="1000"
                      height="667"
                    />
                  </figure>
