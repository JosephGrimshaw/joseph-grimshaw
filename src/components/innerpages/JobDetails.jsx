              ...
              <div className="row g-3 gy-6 lg:g-6 lg:gy-8" data-uc-grid="">
                <div className="col-12 md:col-8 md:order-2">
                  <div className="panel fs-5 vstack gap-2">
                    <p>
                      I am passionate about technology and code as a whole, but particularly AI. I also enjoy pursuing
                      maths to a high level to unlock new possibilities within the world of computing. However,
                      I engage with opportunities across a wide range of domains.
                    </p>
                    {/*}
                    ...
                    */}
                    {resumeData.map((section, index) => (
                      <div>
                        <h3 className="h5 mt-2 mb-1" key={index}>{section.title}</h3>
                        <ul className="m-0">
                          {section.items.map((item, i) => (
                            <li key={i}>{getLink(item)}</li>
                          ))}
                        </ul>
                      </div>
                    ))}
                ...
                <div className="col-12 md:col-4 order-1">
                  <div data-uc-sticky="end: #job_details; offset: 80; media: @m;">
                    <div className="panel vstack gap-3 lg:gap-4 p-2 lg:p-3 rounded bg-secondary dark:bg-gray-800">
                      <h4 className="h5 m-0 pb-2 border-bottom">Personal Details</h4>
                      <div className="vstack gap-2">
                        <div className="hstack gap-1">
                          <i className="icon-1 unicon-portfolio" />
                          <h5 className="h6 m-0">Work Desired</h5>
                        </div>
