          ...
          >
            <div className="vstack items-center gap-2 lg:gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-750px mx-auto text-center">
              ...
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                Please don't hesitate to reach out about any inquiries. I will respond as quickly as possible!
              </p>
            </div>
            <div className="panel max-w-750px mx-auto">
              ...
              >
                <p className="fs-6 text-dark dark:text-white text-opacity-70 mb-2">
                  Have an inquiry? Fill out the form below, and
                ...
                <p className="text-center">
                  Or message me via {" "}
                  <a className="uc-link" href="mailto:1GrimshawJ@truroschool.com">
                    email
                  </a>
                  .
                </p>
