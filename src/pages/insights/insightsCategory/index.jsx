...
export default function InsightsCategory() {
  ...
  const validCards = insightData.filter((elm) => elm.category === category);
  return (
    <>
      ...
      <div className="page-wrapper uni-body panel bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-200 overflow-x-hidden bp-xs bp-sm bp-md bp-lg bp-xl bp-xxl dom-ready">
        ...
        <div id="wrapper" className="wrap">
          <BreadCumb category={category} title="Insights" />
          <CategoryCardArray category={category} cards={validCards} title="Insights" />
          <Newsletter />
        </div>
        <Footer2 />
      </div>
